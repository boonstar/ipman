...
while cv.waitKey(1) < 0:
    ...
    if points[2] and points[3] and points[4]:
        ...
        cv.putText(frame, 'Right arm is not detected', (10, 50), cv.FONT_HERSHEY_SIMPLEX, 0.5, (255, 255, 255), 1)
    ...
    if nr % 5:
        if score > 4:
            score -= 4
        cv.putText(frame, "Come on!!!", (10, 80), cv.FONT_HERSHEY_SIMPLEX, 1, (255, 50, 50), 2)
    else:
        score += 13
        cv.putText(frame, "A champion's punch!", (10, 80), cv.FONT_HERSHEY_SIMPLEX, 1.5, (255, 255, 255), 2)
    cv.putText(frame, "Score: {}".format(score), (10, 120), cv.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0), 2)
